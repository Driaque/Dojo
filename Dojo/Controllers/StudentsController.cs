...
namespace Dojo.Controllers
{
    public class StudentsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "STUDENT_ID,STUDENT_Fname,STUDENT_Lname,STUDENT_DOB,StreetName,Town,PostalCode,PhoneNumber,email,DateJoined,Membership_ID,IsActive,IsParent,Rank_ID,Parent_ID,AttendanceCount,MembershipValidTill")] Student student)
        {
            if (ModelState.IsValid)
            {
